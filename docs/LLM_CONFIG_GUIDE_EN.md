...
```
With only this key, the system defaults to `deepseek/deepseek-v4-flash`. Explicit legacy model
names are not silently rewritten; existing configurations should migrate to
