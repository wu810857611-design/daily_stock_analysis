...
_ACTION_ALIASES = {
    ...
    "buy_1_0": "buy_1.0_cheng",
    "buy_1.0_cheng": "buy_1.0_cheng",
    "模拟买入1成": "buy_1.0_cheng",
    ...
    "add_1_0": "add_1.0_cheng",
    "add_1.0_cheng": "add_1.0_cheng",
    "模拟加仓1成": "add_1.0_cheng",
...
def record_signal(
    ...
    **overrides: Any,
    ...
    record = {
        ...
        "scan_generated_at": str(raw.get("scan_generated_at") or ""),
        "opportunity_tier": str(raw.get("opportunity_tier") or ""),
        "tranche_fraction": copy.deepcopy(raw.get("tranche_fraction")),
        "simulation_only": True,
        "human_review_required": True,
    }
